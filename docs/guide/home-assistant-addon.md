...
| `qn_live_weight_ack`         | unset                | QN-family scales only. Answer every live weight frame with its own weight, as the vendor app does. Try `true` if your QN scale completes the handshake and then reports nothing.                                                    |
