...
A cross-platform CLI tool that reads body composition data from **25+ BLE smart scales** and exports to **Garmin Connect**, **Strava**, **Intervals.icu**, **Runalyze**, **MQTT** (Home Assistant), **InfluxDB**, **Webhooks**, **Ntfy**, **Telegram**, and **local files** (CSV/JSONL). No phone app needed. Your data stays on your device.
...
- **[10 export targets](https://blescalesync.dev/exporters).** Garmin Connect, Strava, Intervals.icu, Runalyze, MQTT (Home Assistant), InfluxDB, Webhook, Ntfy, Telegram, File (CSV/JSONL).
